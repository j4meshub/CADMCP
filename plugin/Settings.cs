...
public sealed class CadMcpSettings
{
    ...
    public static readonly string[] ToolNames = { "say_hello", "get_current_document_info", "get_selected_entities", "query_entities", "send_code_to_cad", "get_execution_status", "create_line", "create_polyline", "create_circle", "create_text", "get_entity_details", "set_selection", "clone_entities", "transform_entities" };
